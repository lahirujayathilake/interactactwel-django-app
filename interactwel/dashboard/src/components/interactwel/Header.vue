            ...
            <b-navbar style="background-color: #263238!important;" toggleable="md" type="dark" variant="secondary">
                ...
                <b-collapse id="nav-collapse" is-nav>
                    <b-navbar-nav>
                        ...
                        <b-nav-item href="#"><router-link to="/community">Community</router-link></b-nav-item>
                        <b-nav-item href="#"><router-link to="/projects">Project</router-link></b-nav-item>
                        <b-nav-item href="#"><router-link to="/plans/1">Plans</router-link></b-nav-item>
