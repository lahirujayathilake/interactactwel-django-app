<template>
  ...
  >
    ...
    <b-alert :show="feedbackRecorded">
      Your feedback has been recorded. Edit it if required and submit again.
    </b-alert>
    <div class="card-body no-padding">
      <div v-if="feedbackAlreadyProvided && showOldFeedbackView">
        <old-feedback-view :feedback="oldFeedback" />
      </div>
      <div v-if="showAddFeedbackForm">
        <div id="feedback-block">
          <b-form
            v-show="initialFeedback"
          ...
          >
            <b-form-group label="Do you think the actions and timeframes presented in this plan are feasible?">
              <b-form-radio-group
                v-model="feasibility"
                required
                name="feasibility-choice"
                :options="feasibilityChoice"
              />
            </b-form-group>
