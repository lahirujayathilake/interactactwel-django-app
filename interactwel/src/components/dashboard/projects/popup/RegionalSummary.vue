<template>
  ...
  >
    <div class="card-header">
      <strong>Sub-basin ID : {{ subbasinID }}</strong><span
        class="close"
        @click="dismiss"
      ><font-awesome-icon
        icon="times-circle"
      ...
      <b-tabs card>
        ...
        <b-tab title="Precipitation">
          <b-row>
            <b-col>
              <line-chart
                :chart-data="datacollectionprism"
                :options="optionsprism"
                :width="5"
                :height="3"
              />
            </b-col>
