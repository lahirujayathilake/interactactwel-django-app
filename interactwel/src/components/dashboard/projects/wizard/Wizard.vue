      ...
      <b-tab :disabled="isStep2Active === false">
        ...
        >
            ...
            >
              ...
              >
                ...
                <b-card-text>
                  ...
                  <p align="justify">
                    In <b>Step 3</b>, think about types of actions would be of interest to the actors you selected in Step 2 and select from the options available on the list. Please note that your adaptation plans (in Step 4) may include additional actions. But more on that when you reach Step 4!
                  </p>
                </b-card-text>
              </b-card>
            </b-collapse>
          ...
          >
            ...
            <b-card-body>
              <p class="card-text">
                <i> Please choose from the drop-down menu the actor for which you want to define the possible actions.</i>
              </p>
        ...
        >
          <div class="help-block-viz">
            ...
            >
              ...
              >
                <h4 class="card-title">
                  "What are Adaptation Plans?"<b-button
          ...
          >
            ...
            <em slot="footer">
              ...
              <b-button
                ...
                variant="next"
                size="sm"
                @click="step4NextClicked"
              >Next</b-button>
              <b-button
                id="step2-back-btn"
                variant="back"
                size="sm"
                @click="step4BackClicked"
              >Back</b-button>
          ...
          >
            ...
            <em slot="footer">
              ...
              <b-button
                ...
                variant="next"
                size="sm"
                @click="step5NextClicked"
              >Next</b-button>
              <b-button
                id="step3-back-btn"
                variant="back"
                size="sm"
                @click="step5BackClicked"
              >Back</b-button>
            </em>
          </b-card>
        </div>
