            ...
            <b-card no-body>
                <div class="col-4 p-3">
                    <b-form @submit.stop.prevent="submitAction">
                        <b-form-select v-model="selectedProject" :options="projects" size="sm" class="mt-3"
                                       required></b-form-select>
                        <b-form-select v-model="selectedUser" :options="users" size="sm" class="mt-3"
                                       required></b-form-select>
                        <b-form-select v-model="selectedStatus" :options="statusList" size="sm" class="mt-3"
                                       required></b-form-select>
                        <b-form-select v-model="selectedRole" :options="roles" size="sm" class="mt-3"
                                       required></b-form-select>
                        <b-form-select v-model="selectedSector" :options="sectors" size="sm" class="mt-3"
                                       required></b-form-select>
                        <b-form-select v-model="selectedActor" :options="actors" size="sm" class="mt-3"
                                       required></b-form-select>

                        <b-button type="submit" variant="success" size="sm" class="mt-3" style="float:right">Assign
                        </b-button>
                    </b-form>
