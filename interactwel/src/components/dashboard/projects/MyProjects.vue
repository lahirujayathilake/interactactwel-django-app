            ...
            <b-tabs pills card vertical nav-wrapper-class="w-25">
                ...
                <b-tab title="Umatilla">
                    <b-card-body title="Umatilla Region Adapts To Changes In Allocation Of Water For irrigation">
                        ...
                        <div class="mt-3">
                            <b-button class="mr-2" disabled>Status</b-button>
                            <b-button class="mr-2" disabled>Send Email</b-button>
                            <b-button class="mr-2" disabled>Unjoin</b-button>
                            <b-button class="mr-2" disabled>Invite</b-button>
                            <b-button class="mr-2"><router-link to="/visualize/1">Visualize</router-link></b-button>
                            <b-button class="mr-2"><router-link to="/adaptation-plans/1">Adaptation Plans</router-link></b-button>
                        </div>
                    </b-card-body>
                </b-tab>
                    ...
                    <b-card-text>
                        <b-card-body title="Colarado Region Adapts To Changes In Allocation Of Water For irrigation">
                            ...
                            <div class="mt-3">
                                ...
                                <b-button class="mr-2" disabled>Unjoin</b-button>
                                <b-button class="mr-2" disabled>Invite</b-button>
                                <b-button class="mr-2"><router-link to="/visualize/2">Visualize</router-link></b-button>
                                <b-button class="mr-2"><router-link to="/adaptation-plans/2">Adaptation Plans</router-link></b-button>
                            </div>
                        </b-card-body>
                    </b-card-text>
                </b-tab>
                    ...
                    <b-card-text>
                        <b-card-body title="Texas Region Adapts To Changes In Allocation Of Water For irrigation">
                            ...
                            <div class="mt-3">
                                ...
                                <b-button class="mr-2" disabled>Unjoin</b-button>
                                <b-button class="mr-2" disabled>Invite</b-button>
                                <b-button class="mr-2"><router-link to="/visualize/3">Visualize</router-link></b-button>
                                <b-button class="mr-2"><router-link to="/adaptation-plans/3">Adaptation Plans</router-link></b-button>
                            </div>
                        </b-card-body>
                    </b-card-text>
                </b-tab>
