...
<script>
    ...
    import GaugingStations from '../../../../static/interactwel/gauging_stations';
    import ReservoirList from '../../../../static/interactwel/reservoirs_list.json';
    import WeatherStations from '../../../../static/interactwel/weather_stations.json';
    ...
    export default {
        ...
        created() {
            this.loading = true;
            axios.get("/static/interactwel/subbasins.geojson")
                .then(response => {
                    this.geoJson_subbasin = response.data;
                    this.loading = true;
                })
            axios.get("/static/interactwel/reaches.geojson")
                .then(response => {
                    this.geoJson_reach = response.data;
                    this.loading = true;
                    })
            axios.get("/static/interactwel/irrigated_land.geojson")
                .then(response => {
                    this.geoJson_irrland = response.data;
                    this.loading = true;
                    })
            axios.get("/static/interactwel/water_rigths.geojson")
                .then(response => {
