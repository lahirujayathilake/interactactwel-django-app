    ...
    export default {
        ...
        mounted() {
            ...
            EventBus.$on('CREATE_REGION_SUMMARY', function (selectedBasinID) {
                ...
                this.subbasinID = selectedBasinID;
                axios.get("/static/interactwel/BASIN_Water_Rights.json").then(response => {
                    $this.buildDataCollectionwr(response.data, $this.subbasinID);
                });

                axios.get("/static/interactwel/BASIN_LandUse_chartjs.json").then(response => {
                    $this.buildDataCollectionlnd(response.data, $this.subbasinID);
                });

                axios.get("/static/interactwel/BASIN_IrrLand_chartjs.json").then(response => {
                    $this.buildDataCollectionirr(response.data, $this.subbasinID);
                });
                axios.get("/static/interactwel/BASIN_CropArea_chartjs.json").then(response => {
