...
<script>
    ...
    import ActionsOpts from '../../../../static/interactwel/actions.json';
    import GoalsOpts from '../../../../static/interactwel/goals.json';
    import ActorsOpts from '../../../../static/interactwel/actors.json';
