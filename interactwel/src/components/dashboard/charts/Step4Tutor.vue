<template>
    <div id="graph" class="card">
            ...
            <div class="card-header" slot="header"><span v-on:click="dismiss" class="close"><font-awesome-icon
                icon="times-circle"/>Close</span>
                <strong style="font-size: 18px">What are Adaptation Plans?</strong>
            </div>
            <div class="card-body">
            ...
            <footer class="tutor-footer">
                <slot name="footer">
                    <button type="button" class="btn-close" @click="dismiss">Continue</button>
                </slot>
            </footer>
